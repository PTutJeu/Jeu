    ...
    public void execQuery() {
        try {
            ...
            rq.request("CREATE TABLE DETAILS_PLANETE(ID NUMBER, OXYGENE NUMBER, TEMPERATURE NUMBER, "
                    ...
                    + "METALPROD NUMBER, LASTCOLLECT NUMBER, "
                    + "CONSTRAINT PK_DETAILSPLANETE PRIMARY KEY (ID));");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(0, 23, 25, '', '', 'Cartez', 0, 20, 25, 25, 1, 1, 1, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(1, 23, 56, 'Combinaison Refroidissante', '', 'Chalr', 0, 25, 30, 30, 1, 1, 2, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(2, 23, -15, 'Combinaison Chauffante', '', 'Fraom', 0, 60, 0, 0, 3, 0, 0, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(3, 23, 25, '', '', 'Gorphei', 0, 0, 40, 40, 0, 2, 2, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(4, 2, 25, 'Masque à Oxygène', 'Bouteille d''Oxygène', 'Gazos', 0, 0, 0, 80, 0, 0, 4, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(5, 23, 25, '', '', 'Noidea', 0, 50, 50, 50, 2, 2, 2, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(6, 23, 25, '', '', 'Dontno', 0, 75, 75, 0, 3, 3, 0, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(7, 23, 25, '', '', 'Ouate', 0, 60, 60, 60, 3, 3, 3, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(8, 23, 25, '', '', 'Unnamed', 0, 80, 0, 80, 4, 0, 4, 0);");
            rq.request("INSERT INTO DETAILS_PLANETE VALUES(9, 23, 25, '', '', 'Unknown', 0, 100, 100, 100, 4, 4, 4, 0);");
